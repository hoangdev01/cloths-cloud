      ...
      >
        ...
        <Box>
          <Text
            ...
            color={'var(--highlight-color)'}
          >
            Khám phá những địa điểm mới lạ !
          </Text>
        </Box>
        {/* <Box>
        ...
        <Box maxW={'50%'} px="5px" role="group">
          <Box overflow={'hidden'} rounded={'10px'}>
            <Image
              ...
              // }
              src={'https://www.anhdulich.vn/storage/sliders/slide4.jpg'}
            />
          </Box>
        </Box>
      ...
      <Box display="flex" alignItems="center" w="full" pt="105px" pb="111px">
        ...
        <Box w={'50%'} ml={'-45px'} mr={'-10px'} position={'relative'}>
          ...
          <Box
            ...
            px={'40px'}
            py={'25px'}
            boxShadow={'0 10px 60px 0 rgb(0 0 0 / 10%)'}
            w={'264px'}
            h={'82px'}
            br={'10px'}
            rounded={'10px'}
        ...
        <Box w={'50%'} px={'50px'}>
          ...
          <Box>
            <Text
              ...
              fontSize={'16px'}
            >
              Paris lãng mạng, Thành phố Ánh sáng nơi có Arc de Triomphe và Tháp
              Eiffel, bánh mì baguette và thời trang cao cấp. Hãy đội mũ nồi,
              buộc khăn và đắm mình thưởng thức ẩm thực, thỏa sức mua sắm và ghé
              thăm các bảo tàng nơi đây. Bon voyage! Chúc bạn một chuyến đi vui
              vẻ!
            </Text>
          </Box>
          <Box>
        ...
        >
          ...
          <Box py={'10px'} px={'16px'}>
            <Text
              ...
              minHeight={'54px'}
            >
              Vé Cáp Treo Sun World Bà Nà Hills Đà Nẵng
            </Text>
            <Text color={'var(--highlight-color)'} fontSize={'16px'}>
              700,000 VND
            </Text>
          </Box>
          <Box pt={'10px'} px={'16px'}>
        ...
        >
          ...
          <Box py={'10px'} px={'16px'}>
            <Text
              ...
              minHeight={'54px'}
            >
              Vé Cáp Treo Sun World Fansipan Legend
            </Text>
            <Text color={'var(--highlight-color)'} fontSize={'16px'}>
              715,000 VND
            </Text>
        ...
        >
          ...
          <Box py={'10px'} px={'16px'}>
            <Text
              ...
              minHeight={'54px'}
            >
              Vé Công Viên Suối Khoáng Nóng Núi Thần Tài Đà Nẵng
            </Text>
            <Text color={'var(--highlight-color)'} fontSize={'16px'}>
              260,000 VND
            </Text>
